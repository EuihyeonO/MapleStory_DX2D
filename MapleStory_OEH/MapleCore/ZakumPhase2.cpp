...
void Zakum::SetPhase2Attack()
{
	//Attack1
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_1Attack",.SpriteName = "Phase2_1Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.13f, 0.13f, 0.13f, 0.92f, 0.13f, 0.13f, 0.13f, 0.13f} });

	BodyRender->SetAnimationUpdateEvent("Phase2_1Attack", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 11.0f, 10.0f, -4.0f });
	...
	BodyRender->SetAnimationStartEvent("Phase2_1Attack", 3, [this]
		{
	...
	BodyRender->SetAnimationStartEvent("Phase2_1Attack", 4, [this]
		{
	...
	BodyRender->SetAnimationUpdateEvent("Phase2_1Attack", 7,
		[this] {
	...
	//Attack2
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_2Attack",.SpriteName = "Phase2_2Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.2f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f} });

	BodyRender->SetAnimationUpdateEvent("Phase2_2Attack", 0, [this]
		{
	...
	BodyRender->SetAnimationStartEvent("Phase2_2Attack", 9, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationStartEvent("Phase2_2Attack", 11, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationStartEvent("Phase2_2Attack", 13, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationUpdateEvent("Phase2_2Attack", 17, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_3Attack",.SpriteName = "Phase2_3Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f,0.56f, 0.08f, 0.08f, 0.12f } });
	BodyRender->SetAnimationUpdateEvent("Phase2_3Attack", 0,
		[this]
		{
			GetTransform()->SetLocalPosition({ 12.0f, 36.0f, -4.0f });
	...
	BodyRender->SetAnimationStartEvent("Phase2_3Attack", 10, [this]
		{
			int Count = 0;
			while (Count < 5)
			{
				...
				AtObj.lock()->CreateAnimation({ .AnimationName = "Phase2_3AtObj",.SpriteName = "3AtObj",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.2f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f} });
				AtObj.lock()->ChangeAnimation("Phase2_3AtObj");
				...
				for (int i = 0; i < 5; i++)
				{
					AtObj.lock()->SetAnimationUpdateEvent("Phase2_3AtObj", i + 8, [AtObj, AtObjCol, i]
						{
				...
				AtObj.lock()->SetAnimationUpdateEvent("Phase2_3AtObj", 14, [AtObjCol] {AtObjCol.lock()->Off(); });
				AtObj.lock()->SetAnimationUpdateEvent("Phase2_3AtObj", 18, [AtObj, AtObjCol] {if (AtObj.lock()->IsAnimationEnd() == true) { AtObjCol.lock()->Death(); AtObj.lock()->Death(); }});

				Count++;
			}
		});

	BodyRender->SetAnimationUpdateEvent("Phase2_3Attack", 12, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				GetTransform()->SetLocalPosition({ 12, 7.0f, -4.0f });
				isAttack = false;
				GetLevel()->TimeEvent.AddEvent(3.0f, [this](GameEngineTimeEvent::TimeEvent&, GameEngineTimeEvent*) {isBodyAttCoolTime = false; });
				BodyRender->ChangeAnimation("Phase2Stand");
			}
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_1Skill",.SpriteName = "Phase2_1Skill",.FrameInter = 0.088f,.Loop = false,.ScaleToTexture = true });

	BodyRender->SetAnimationUpdateEvent("Phase2_1Skill", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12, 26, -4.0f });
	...
	BodyRender->SetAnimationUpdateEvent("Phase2_1Skill", 16, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase2Stand");
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_2Skill",.SpriteName = "Phase2_2Skill",.FrameInter = 0.093f,.Loop = false,.ScaleToTexture = true });
	BodyRender->SetAnimationUpdateEvent("Phase2_2Skill", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12, 22, -4.0f });
	...
	BodyRender->SetAnimationUpdateEvent("Phase2_2Skill", 15, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase2Stand");
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase2_3Skill",.SpriteName = "Phase2_3Skill",.FrameInter = 0.094f,.Loop = false,.ScaleToTexture = true });

	BodyRender->SetAnimationUpdateEvent("Phase2_3Skill", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12, 22, -4.0f });
	...
	BodyRender->SetAnimationUpdateEvent("Phase2_3Skill", 15, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase2Stand");
