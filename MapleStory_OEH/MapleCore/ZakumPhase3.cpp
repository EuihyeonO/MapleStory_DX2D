...
void Zakum::SetPhase3Attack()
{
	//Attack1
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_1Attack",.SpriteName = "Phase3_1Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.13f, 0.13f, 0.13f, 0.92f, 0.13f, 0.13f, 0.13f, 0.13f} });

	BodyRender->SetAnimationUpdateEvent("Phase3_1Attack", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12.0f, 17.0f, -4.0f });
	...
	BodyRender->SetAnimationStartEvent("Phase3_1Attack", 3, [this]
		{
	...
	BodyRender->SetAnimationStartEvent("Phase3_1Attack", 4, [this]
		{
	...
	BodyRender->SetAnimationUpdateEvent("Phase3_1Attack", 7,
		[this] {
	...
	//Attack2
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_2Attack",.SpriteName = "Phase3_2Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.2f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f} });

	BodyRender->SetAnimationUpdateEvent("Phase3_2Attack", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12.0f, 18.0f, -4.0f });
	...
	BodyRender->SetAnimationStartEvent("Phase3_2Attack", 9, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationStartEvent("Phase3_2Attack", 11, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationStartEvent("Phase3_2Attack", 13, [this]
		{
			for (int i = 0; i < 5; i++)
			{
				std::weak_ptr<GameEngineSpriteRenderer> Eff1 = CreateComponent<GameEngineSpriteRenderer>();
	...
	BodyRender->SetAnimationUpdateEvent("Phase3_2Attack", 17, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				GetTransform()->SetLocalPosition({ 12, 18, -4.0f });
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_3Attack",.SpriteName = "Phase3_3Attack",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f, 0.08f,0.56f, 0.08f, 0.08f, 0.12f } });
	BodyRender->SetAnimationUpdateEvent("Phase3_3Attack", 0,
		[this]
		{
			GetTransform()->SetLocalPosition({ 12.0f, 29.0f, -4.0f });
	...
	BodyRender->SetAnimationStartEvent("Phase3_3Attack", 10, [this]
		{
			int Count = 0;
			while (Count < 5)
			{
				...
				AtObj.lock()->CreateAnimation({ .AnimationName = "Phase3_3AtObj",.SpriteName = "3AtObj",.Loop = false,.ScaleToTexture = true,.FrameTime = {0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.105f, 0.2f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f, 0.09f} });
				AtObj.lock()->ChangeAnimation("Phase3_3AtObj");
				...
				AtObj.lock()->SetAnimationUpdateEvent("Phase3_3AtObj", 14, [AtObjCol] {AtObjCol.lock()->Off(); });
				AtObj.lock()->SetAnimationUpdateEvent("Phase3_3AtObj", 18, [AtObj, AtObjCol] {if (AtObj.lock()->IsAnimationEnd() == true) { AtObjCol.lock()->Death(); AtObj.lock()->Death(); }});

				Count++;
			}
		});

	BodyRender->SetAnimationUpdateEvent("Phase3_3Attack", 12, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				GetTransform()->SetLocalPosition({ 12, 18, -4.0f });
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_1Skill",.SpriteName = "Phase3_1Skill",.FrameInter = 0.088f,.Loop = false,.ScaleToTexture = true });

	BodyRender->SetAnimationUpdateEvent("Phase3_1Skill", 0, [this]
		{
	...
	BodyRender->SetAnimationUpdateEvent("Phase3_1Skill", 16, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase3Stand");
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_2Skill",.SpriteName = "Phase3_2Skill",.FrameInter = 0.093f,.Loop = false,.ScaleToTexture = true });
	BodyRender->SetAnimationUpdateEvent("Phase3_2Skill", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12, 17, -4.0f });
	...
	BodyRender->SetAnimationUpdateEvent("Phase3_2Skill", 15, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase3Stand");
	...
	BodyRender->CreateAnimation({ .AnimationName = "Phase3_3Skill",.SpriteName = "Phase3_3Skill",.FrameInter = 0.094f,.Loop = false,.ScaleToTexture = true });

	BodyRender->SetAnimationUpdateEvent("Phase3_3Skill", 0, [this]
		{
			GetTransform()->SetLocalPosition({ 12, 21, -4.0f });
	...
	BodyRender->SetAnimationUpdateEvent("Phase3_3Skill", 15, [this]
		{
			if (BodyRender->IsAnimationEnd() == true)
			{
				BodyRender->ChangeAnimation("Phase3Stand");
